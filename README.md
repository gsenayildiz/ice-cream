...
- Bu projede,  bir ürünün adını, görselini ve miktarını görüntüler ve sepete ürün ekleyip çıkarma işlevi sağlar. Testler, sepette bulunan ürün miktarını ve görüntüyü doğru şekilde gösterip göstermediğini, ayrıca sepetteki ürünlere göre butonların aktif olup olmadığını doğrular. Butonlara tıklama olaylarında, sepete ürün ekleme ve çıkarma işlemlerinin doğru parametrelerle çalışıp çalışmadığını kontrol eden testler bulunur.
